...
namespace RimMind.Memory.Tests
{
    public class DarkMemoryResultParserTests
    {
        ...
        public void Parse_ExceedsMaxCount_Truncates()
        {
            ...
            var result = DarkMemoryResultParserPure.Parse(json, maxCount: 3);
        ...
        {
            var result = DarkMemoryResultParserPure.Parse("not json", maxCount: 10);
            Assert.Null(result);
        }
        ...
        public void Parse_TruncatedJson_ReturnsNull()
        {
            ...
            var result = DarkMemoryResultParserPure.Parse(truncated, maxCount: 10);
            Assert.Null(result);
        }
        ...
        {
            string json = @"{""dark"": [""a""]}";
            var result = DarkMemoryResultParserPure.Parse(json, maxCount: 0);
